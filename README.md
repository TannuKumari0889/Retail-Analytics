# 🛍️ Retail-Analytics
Retail analytics project delivering actionable insights through Customer 360 analysis, EDA, and Power BI dashboards.

### 📊 Project Overview
This project focuses on analyzing sales data for a leading retail chain in India to uncover actionable insights that can improve marketing strategies and overall business performance.
...
2. Customer 360 View Creation
Built a unified Customer 360 table by combining multiple datasets
Enabled a holistic view of customer transactions and behavior
3. Exploratory Data Analysis (EDA)
Analyzed sales trends, customer purchase patterns, and product demand
Identified key anomalies and patterns in the dataset
4. Dashboard Development
Designed interactive dashboards in Power BI to track:
Sales performance
...
👉[View Presentation](https://github.com/TannuKumari0889/Retail-Analytics/raw/main/Retail%20Analytics.pptx)
